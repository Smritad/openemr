<?php /* Smarty version 2.6.33, created on 2026-05-29 13:45:34
         compiled from default/views/day_print/outlook_ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day_print/outlook_ajax_template.html', 11, false),array('function', 'headerTemplate', 'default/views/day_print/outlook_ajax_template.html', 203, false),array('function', 'pc_sort_events', 'default/views/day_print/outlook_ajax_template.html', 280, false),array('modifier', 'date_format', 'default/views/day_print/outlook_ajax_template.html', 275, false),array('modifier', 'string_format', 'default/views/day_print/outlook_ajax_template.html', 276, false),)), $this); ?>
            ...
            if ($catid == 2 || $catid == 3 || $catid == 4 || $catid == 8 || $catid == 11) {
                ...
                if ($patientid) {
                    ...
                    if ($GLOBALS['calendar_appt_style'] != 1) {
                        $content .= "," . text($fname);
                          if ($event['title'] &&  $GLOBALS['calendar_appt_style'] == 5) { //RM
